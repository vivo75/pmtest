...
`pytests-contract-suite/corpus.py`). A changed Rust output is flagged for review
...
def test_expanded_corpus_replays(emerge_binary):
    ...
    assert cases, "pytests-contract-suite/corpus/expanded.json.xz is missing or empty"
