...
# `differential-test-bed/compare/resolve-compare.py` does the diffing.
#
# Usage (from the host orchestrator; see differential-test-bed/run/l0-resolver.sh):
...
#                               runs read by differential-test-bed/compare/check-invariants.py
