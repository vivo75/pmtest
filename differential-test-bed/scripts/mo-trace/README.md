...
```sh
differential-test-bed/scripts/mo-trace/ptl-trace.sh /tmp/gtk4 -- --pretend --debug app-misc/gtk:4
...
#    the container.
differential-test-bed/scripts/mo-trace/ptl-trace.sh /tmp/gtk4 -- --pretend app-misc/gtk:4

# 3. align
python3 differential-test-bed/scripts/mo-trace/align-traces.py gtk4.real.trace /tmp/gtk4.portuale.trace
```
