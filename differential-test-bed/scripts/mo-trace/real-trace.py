...
`differential-test-bed/scripts/mo-trace/README.md`.
...
BEGIN = "            # MO_SEL_TRACE_BEGIN (injected by differential-test-bed/scripts/mo-trace/real-trace.py)\n"
...
ORDER_BEGIN = "        # MO_ORDER_TRACE_BEGIN (injected by differential-test-bed/scripts/mo-trace/real-trace.py)\n"
