...
#
#   differential-test-bed/run/l2-portuale-builder.sh [atomlist]      (default l1-merge.txt)
#   differential-test-bed/run/l2-portuale-builder.sh differential-test-bed/atomlists/l1-porttest.txt
#
