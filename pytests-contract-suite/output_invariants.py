...
consistent). Used by `pytests-contract-suite/test_output_invariants.py` over the contract
cases and the harvested corpus, and by `differential-test-bed/compare/check-invariants.py`
over L0 output.
"""
