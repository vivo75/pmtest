...
(`pytests-contract-suite/output_invariants.py`).
...
Usage: check-invariants.py differential-test-bed/logs/l0-<stamp>
...
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "pytests-contract-suite"))
