...
# `differential-test-bed/compare/resolve-compare.py` already consumes:
#
...
#
# Usage (from differential-test-bed/run/l0-fixture-oracle.sh):
...
# Portage pin: portuale mirrors PIN (differential-test-bed/run/l0-resolver.sh's own step),
...
# cascade splits across both (B0b; `differential-test-bed/findings/l0.md` "#68/#72 B0b",
