...
behaviour. `differential-test-bed/create-container.bash` bakes this into
...
Run: `differential-test-bed/run/l1-merge-from-binpkg.sh differential-test-bed/atomlists/l1-porttest.txt`.
...
so `L2_CACHELESS=1 differential-test-bed/run/l2-portuale-builder.sh
differential-test-bed/atomlists/l1-porttest.txt` exercises that path. Keeping the cache
