...
mkdir -p differential-test-bed/{scripts,logs}
...
# (source of truth: differential-test-bed/images/overlay/porttest/; ebuilds land in slice 3).
OVERLAY_SRC=""
for cand in \
  "${BASEDIR}/images/overlay/porttest" \
  "${BASEDIR}/../differential-test-bed/images/overlay/porttest" \
  "${BASEDIR}/../../differential-test-bed/images/overlay/porttest" ; do
